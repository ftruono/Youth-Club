...
public class BeanLocale {
    ...
    public BeanLocale(String fonte) {
    ...
    public BeanLocale(int id, int idPlace, String nome, String via, String numeroCellulare, int numVotanti,
